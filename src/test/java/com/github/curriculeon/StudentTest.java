...
public class StudentTest {
    ...
    public void testConstructor_returnsFN_LN_ExamScores() {
        ...
        Double[] examScores = {67.0, 74.0, 85.0};
        ArrayList<Double> expected = new ArrayList(Arrays.asList(examScores));
        Student student = new Student("Katrina", "High", examScores);
        //Act
        String actualFn = student.getFirstName();
        String actualLn = student.getLastName();
        ArrayList<Double> actualScores = student.getTestScores();
        //Assert
